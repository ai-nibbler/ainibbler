    ...
    <footer className="py-10 border-t border-border">
      ...
      <div className="flex items-center justify-between mt-10 pt-6 border-t border-border">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href={SUBSTACK_URL} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Substack">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Instagram">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
